...
class RotatingFileHandlerWithFileFormatterWithRolloverTest(unittest.TestCase, FormatterExtension):
    ...
    def setUp(cls):
        ...
        cls.logger.addHandler(LoggerBuilder.get_file_handler("dummy.txt", Levels.DEBUG))
